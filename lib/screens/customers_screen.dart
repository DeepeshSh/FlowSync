...
import 'edit_customer_screen.dart'; // Imported to navigate to Edit Customer screen
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Bal: ${customer.openingBalance.toStringAsFixed(2)}",
                  style: const TextStyle(
                    color: Color(0xFF1E293B),
          ...
          GestureDetector(
            onTap: () => showActionSelectionMenu(customer),
            child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  title: const Text("Edit Customer Profile", style: TextStyle(fontWeight: FontWeight.w600)),
                  onTap: () {
                ...
                ListTile(
                  ...
                  title: const Text("Remove Customer", style: TextStyle(color: Colors.red, fontWeight: FontWeight.w600)),
                  onTap: () {
                    Navigator.pop(context);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                Text(
                  "Are you sure you want to completely delete \"${customer.customerName}\" from your customer index records?",
                  textAlign: TextAlign.center,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: const [
                                    ...
                                    SizedBox(height: 2),
                                    Text(
                                      "Manage customer network & receivables",
